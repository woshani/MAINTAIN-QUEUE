...
<%
    ...
    Conn conn = new Conn();
    String typeCode = "select queue_type,queue_type_name from pms_queue_type where status = 'Active' and hfc_cd = '"+hfc+"'";
...
<script>
        ...
        if (code === "" || name === "") {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    console.log(data);
                    bootbox.alert("Queue Name successfully been saved");
                    $.ajax({
                        type: "post",
    ...
    $('#delName').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                console.log(data);
                bootbox.alert("Queue Name successfully been deleted");
                $.ajax({
                    type: "post",
                    url: "listQueueName.jsp",
                    timeout: 3000,
